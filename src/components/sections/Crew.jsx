  ...
  return (
    <section id="crew" className="section-shell">
      ...
      <div className="mt-14 grid gap-5 md:grid-cols-3">
        {crew.map(({ name, role, responsibility, image }) => (
          <article key={name} className="glass-panel group p-4 transition-transform duration-500 hover:-translate-y-2 focus-within:-translate-y-2 sm:p-6">
